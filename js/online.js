...
const loadTournamentInfo = async () => {
  ...
  try {
    ...
    const infoContainer = document.getElementById('online-info');
    ...
    infoContainer.innerHTML = `
      ...
      <div class="info-item">
        <div class="info-label">عدد اللاعبين</div>
      ...
      .map((match) => `
        <div class="match-item">
          <div class="match-teams">
            <div class="team">${match.participant1?.name || 'بانتظار اللاعب'}</div>
          ...
          <div style="flex: 1; text-align: right;">
            <div class="team">${match.participant2?.name || 'بانتظار اللاعب'}</div>
